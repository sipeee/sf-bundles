...
class MimeType
{
    private const MIME_TYPE_EXTENSION_MAPPING = [
    ...
    {
        $defaultMimeTypes = array_flip(self::MIME_TYPE_EXTENSION_MAPPING);

        $mimeType = @$defaultMimeTypes[strtolower(self::getExtension($filename))];
